...
- **功能范围**：`[P1]`（REQ-001..REQ-011 / U-01..U-12，见 `docs/03-prd.md` §3 路线图）
- **交付物形态**：**Demo** — 跑通"导入 → 检索 → 问答带来源 → 编辑留版本"最小闭环，演示 LUMEN 核心价值；可用最简实现 / 明确 Mock，**保留产品红线**（库外问答回复"未找到"、不编造）；不默认称为 MVP
