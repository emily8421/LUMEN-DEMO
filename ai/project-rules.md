...
当前阶段：Phase1（含 Phase1.5A/B 个人可用收口候选；未进入 Phase2A/2B）

> 双维度（global-rules §8.1）：每个阶段同时声明**功能范围**与**交付物形态**，两者正交、不得混用。
- **功能范围**：`[P1]`（REQ-001..REQ-011、REQ-036 / U-01..U-12、U-42；Phase1.5A 候选 REQ-037/038；Phase1.5B 候选 REQ-027，见 `docs/03-prd.md` §3 路线图）
- **交付物形态**：**Demo / 个人可用增强** — Demo 跑通"导入 → 检索 → 问答带来源 → 编辑留版本 → 术语对齐"最小闭环；P1.5A 优先让个人可批量入库、可导出备份；P1.5B 再补 PDF / 真实文本提取 / 搜索增强；**保留产品红线**（库外问答回复"未找到"、不编造）；不默认称为团队 MVP
...
下一阶段预告：
- Phase2A：个人知识组织（内部链接 / 反向链接、标签视图、快速录入索引条目）
