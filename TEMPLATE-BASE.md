...
- Current synced template version: v1.60.2
- Synced at: 2026-08-09
- Project version file: VERSION
- Project version at sync time: v3.7.0
...
- Template sync commits keep the message format `sync template v1.60.2 from ai-project-template`.
