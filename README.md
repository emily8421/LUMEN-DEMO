...
>
> 本项目派生自 [`ai-project-template`](https://github.com/emily8421/ai-project-template)，采用其「文档驱动开发」方法论——**先文档、后代码**；当前已下行同步至模板 **v1.47.1**。
...
本项目派生自 `ai-project-template`，方法论文件随模板演进（当前已同步至 **v1.47.1**）：
...
- **当前同步状态**：已同步至模板 **v1.47.1**，同步记录见 `sync-records/template-sync/2026-07-13-sync-template-v1.47.1.md`。
