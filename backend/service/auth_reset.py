...
def request_password_reset(repository: UserRepository, email: str) -> str:
...
def confirm_password_reset(repository: UserRepository, token: str, new_password: str) -> None:
