...
> 状态：**部分采纳落地关闭**——issue [#357](https://github.com/emily8421/ai-project-template/issues/357) §2.2 已落地（Batch B+C / PR #364，squash `f51b39e`，v1.64.0，2026-08-18 关闭）；§2.1 物理归拢另立评估不在本批；本文件已归档，勿重复提交
