...
| 最后更新 | 2026-08-04（v1.5.2 验证债收口：Sprint-22 folder-tree 浏览器自动化 smoke 通过；Sprint-20 真实 PG 大数据性能 smoke 通过，620 docs + 240 links，density_events=2100，degraded=True，elapsed_ms=2677.61） |
