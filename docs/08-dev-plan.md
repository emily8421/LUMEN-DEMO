...
| Sprint-21（Phase2B·Doc-First UX·slice 3a 布局） | 侧栏可隐藏 + 默认收起 + 三路唤出 + 记忆偏好（§9.5 基线） | 011（P1B 默认行为升级，不新增 REQ） | design/frontend-interaction §9.5、research/prototypes/2026-07-31-obsidian-inspired-*、09 TC-P1-014 | frontend App.tsx + app/{usePaneLayout,pane-layout-store,TopBar} + features/DocumentsFeature + styles | TC-P1-014 回归 + Chrome/Edge smoke | 进行中（feat/step3-doc-first-ux，DF-C-001 门禁已过） | tasks/task-021-pane-visibility.md |
