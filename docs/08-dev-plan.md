...
| 最后更新 | 2026-08-06（Sprint-25 帮助手册 L0+L1 完成：L0 user-guide 任务导向重组 + L1 首次引导 / 新手清单 / 空状态引导 / 帮助速查过滤；自动化 + 人工 smoke 通过，验收期修复 2 缺陷） |
