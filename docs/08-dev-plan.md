...
| 最后更新 | 2026-08-04（v1.5.2 验证债收口：Sprint-22 `scripts/smoke-folder-tree-browser.mjs` 通过；Sprint-20 `scripts/smoke-timeline-pg-performance.py --documents 620 --links 240 --max-seconds 12` 通过，真实 PG `density_events=2100`、`degraded=True`、`elapsed_ms=2677.61`） |
