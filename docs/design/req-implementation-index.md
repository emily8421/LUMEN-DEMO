...
| REQ-018 | [P2] | MOD-008 本地知识源；`docs/design/ingestion.md` Flow-D-014 + `docs/design/frontend-interaction.md` §9.3；模式 A 随 Phase2B 交付、模式 B 浏览器路线（RG-009 Go）；`lumen_vault_mounts` 跨设备元数据**已落地**（Wave 3，migration 015 + API-059 + TC-P2-VAULT-004 通过 2026-08-18，v3.11.0）；FileSystemObserver 自动重扫**已落地**（Wave 3，TC-P2-VAULT-003 通过 2026-08-18，v3.12.0，Wave 3 收口）；TC-P2-VAULT-001；Sprint-23C |
