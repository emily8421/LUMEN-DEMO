...
| 最后更新 | 2026-08-02（timeline 设计回填：新增 PG-P2-008 时间轴 / 密度热条视图 + Phase2B 状态行候选 A 已定，REQ-013/024 第二 slice）；前版回写 REQ-014 闭环 + §9.5 Doc-First 候选基线 |
...
| Phase2B `[P2]` | **范围已确认·设计就绪（2026-07-30）** | AI 润色 / 写作引用（REQ-014 首批核心，挂 PG-P2-003 + CMP-P2-AI-POLISH，见 §9.2/§9.3）、时间轴 / 密度热条（REQ-013/024 第二 slice·已设计 PG-P2-008，候选 A + TL-C-001..008 已确认）；数据外发已接受（RG-008）、AI 降级 5030 已定；UI smoke 待 Sprint-20 |
...
| PG-P2-008 | 时间轴 / 密度热条视图 | 空间内可选视图、首页快捷入口 | 已登录空间成员 | REQ-013/024、`docs/design/timeline.md`（候选 A 实时聚合） | `[P2]` Phase2B 第二 slice | 草案·已设计（TL-C-001..008 已确认） | 顶部密度热条（4 档色阶）+ 下方事件列表 + 大集合切列表逃生舱；越权事件不显示 |
...
- **时间轴**（REQ-013/024，第二 slice）：独立视图，主体时间线优先、过滤器默认隐藏；Sprint-20 前补 Page-ID / Flow-ID + 确认 D-T-001 数据来源。
