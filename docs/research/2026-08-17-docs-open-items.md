...
| OI-104（已关闭 2026-08-18） | 2026-08-17 | handoff | hotspot rollup 已达阈值（5 份本地未汇总） | 会话收尾汇总入 SUMMARY.md | token-hotspot 规则 | — | 治理 | 下次会话收尾 | 不阻塞 | `ai-records/token-hotspots/SUMMARY.md` | 已关闭 | 阶段 D 已汇总入 SUMMARY.md（08-14~08-17 五份）+ 5 份本地记录补标 + 入库 PR #201（`07b72a2`） |
| OI-105 | 2026-08-17 | handoff / 跨仓 | 模板仓 7 份提案 issue triage | 模板维护者另行处理 | 跨仓协作 | — | 治理 | 任意时点 | 不阻塞 | 模板仓 | 待确认 | — |
| OI-105（已关闭 2026-08-18） | 2026-08-17 | handoff / 跨仓 | 模板仓 7 份提案 issue triage | 模板维护者另行处理 | 跨仓协作 | — | 治理 | 任意时点 | 不阻塞 | 模板仓 | 已关闭 | 维护者 Batch A/B+C 三批落地（PR #362/#363/#364，v1.63.0/v1.64.0）：6 份吸收关闭（#350/#354-#358，#357 部分采纳）、归档 `_archive/proposals/`；在途 2 份转长期跟踪（#334 暂无回应 / #370 新开），无需派生侧动作；v1.64.0 已随 PR #207 同步，运行记录补写 `sync-records/template-sync/2026-08-18-sync-template-v1.64.0.md` |
...
| OI-109（已关闭 2026-08-18） | 2026-08-06 | 09 TC-P2-VAULT-004 | vault 跨设备元数据 `lumen_vault_mounts`（migration 015）落地 | 账户体系稳定后编码 | 09 已登记顺延（014 被占用） | — | 增强 | 后续批 | 不阻塞 | `docs/06`、09 | 已关闭 | Wave 3 编码完成：migration 015 + API-059 + 前端接线（useVaultMountSync / LocalMountRemoteList），TC-P2-VAULT-004 通过（单测 331 + 真实 PG + API smoke + 浏览器 smoke），06/07/08/09/design 契约已回写，v3.11.0 |
...
- OI-103（部署执行）为人工待办，条件阻塞发布，不影响文档与代码维护；OI-104（hotspot rollup）已关闭（2026-08-18，阶段 D 已入库）。
