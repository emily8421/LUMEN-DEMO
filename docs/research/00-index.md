...
| `2026-08-19-frontend-remediation-plan.md` | 前端修复候选实施计划（评估结论到独立工作包的转译；二次评审后修订：FEP-05 补修改范围与 FEP-04 协同触发、FEP-01 验收补验证手段、FEP-03 补错误留痕） | 已落盘；**候选计划 · 未授权编码** | 五个工作包按无障碍、交互韧性、测试基础设施、刷新竞态、维护债拆分；FE-ERR-1 随下次触及 client.ts 合并；仅在用户批准具体工作包后，才回填 `08` / `09` 并建立任务单 |
